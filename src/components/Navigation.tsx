...
import { MapPin, Phone, Mail, ChevronRight, Globe, Facebook } from 'lucide-react';
...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="bg-green-800 text-white py-2 text-xs sm:text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
          <div className="flex items-center space-x-4 mb-2 sm:mb-0">
            <span className="flex items-center"><Phone className="w-3 h-3 mr-1" /> +254 (0) 700 000 000</span>
          ...
          <div className="flex items-center space-x-4 font-medium">
            ...
            <button 
              ...
              className="flex items-center hover:text-green-200 transition-colors bg-green-700/50 px-2 py-1 rounded-md"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center py-3 md:py-0 md:h-20 gap-3 md:gap-0">
          <Link to="/" className="flex items-center space-x-3 shrink-0">
            {/* Using a placeholder shield/logo for the county */}
            ...
            <div>
              <h1 className="font-bold text-xl text-gray-900 leading-tight">Taita Taveta</h1>
              <p className="text-xs text-green-700 font-semibold tracking-wider uppercase">County Government</p>
            </div>
          </Link>

          {/* Navigation */}
          <nav className="flex overflow-x-auto hide-scrollbar space-x-1 sm:space-x-2 py-2 w-full md:w-auto">
            {links.map((link) => (
              <Link
                key={link.path}
                to={link.path}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="font-bold text-lg leading-tight">Taita Taveta</h2>
                <p className="text-[10px] text-green-400 font-semibold tracking-wider uppercase">County Government</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex items-start">
                ...
                <span>County Headquarters, Wundanyi<br/>P.O. Box 1062 - 80304,<br/>Wundanyi, Kenya</span>
              </li>
